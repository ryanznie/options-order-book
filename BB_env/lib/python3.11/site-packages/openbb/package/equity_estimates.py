...
class ROUTER_equity_estimates(Container):
    ...
    def analyst_search(
        self,
        analyst_name: Annotated[Union[str, None, List[Optional[str]]], OpenBBCustomParameter(description='Analyst names to return. Omitting will return all available analysts. Multiple comma separated items allowed for provider(s): benzinga.')] = None,
        firm_name: Annotated[Union[str, None, List[Optional[str]]], OpenBBCustomParameter(description='Firm names to return. Omitting will return all available firms. Multiple comma separated items allowed for provider(s): benzinga.')] = None,
        provider: Annotated[Optional[Literal['benzinga']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'benzinga' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'analyst_name': {'multiple_items_allowed': ['benzinga']}, 'firm_name': {'multiple_items_allowed': ['benzinga']}, 'analyst_ids': {'multiple_items_allowed': ['benzinga']}, 'firm_ids': {'multiple_items_allowed': ['benzinga']}, 'fields': {'multiple_items_allowed': ['benzinga']}},
            )
        )
    ...
    def consensus(
        self,
        symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for. Multiple comma separated items allowed for provider(s): fmp, tmx, yfinance.')],
        provider: Annotated[Optional[Literal['fmp', 'tmx', 'yfinance']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def price_target(
        self,
        symbol: Annotated[Union[str, None, List[Optional[str]]], OpenBBCustomParameter(description='Symbol to get data for. Multiple comma separated items allowed for provider(s): benzinga, finviz, fmp.')] = None,
        limit: Annotated[int, OpenBBCustomParameter(description='The number of data entries to return.')] = 200,
        provider: Annotated[Optional[Literal['benzinga', 'finviz', 'fmp']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'benzinga' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'multiple_items_allowed': ['benzinga', 'finviz', 'fmp']}},
            )
        )
