...
class ROUTER_currency(Container):
    ...
    def search(
        self,
        provider: Annotated[Optional[Literal['fmp', 'intrinio', 'polygon']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
        """Currency Search.
    ...
    def snapshots(
        self,
        base: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='The base currency symbol. Multiple comma separated items allowed for provider(s): fmp.')] = 'usd',
        quote_type: Annotated[Literal['direct', 'indirect'], OpenBBCustomParameter(description="Whether the quote is direct or indirect. Selecting 'direct' will return the exchange rate as the amount of domestic currency required to buy one unit of the foreign currency. Selecting 'indirect' (default) will return the exchange rate as the amount of foreign currency required to buy one unit of the domestic currency.")] = 'indirect',
        counter_currencies: Annotated[Union[str, List[str], None], OpenBBCustomParameter(description='An optional list of counter currency symbols to filter for. None returns all.')] = None,
