...
class ROUTER_equity_ownership(Container):
    ...
    def form_13f(
        self,
        symbol: Annotated[str, OpenBBCustomParameter(description='Symbol to get data for. A CIK or Symbol can be used.')],
        date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='A specific date to get data for. The date represents the end of the reporting period. All form 13F-HR filings are based on the calendar year and are reported quarterly. If a date is not supplied, the most recent filing is returned. Submissions beginning 2013-06-30 are supported.')] = None,
        limit: Annotated[Optional[int], OpenBBCustomParameter(description='The number of data entries to return. The number of previous filings to return. The date parameter takes priority over this parameter.')] = 1,
        provider: Annotated[Optional[Literal['sec']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'sec' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def share_statistics(
        ...
        provider: Annotated[Optional[Literal['fmp', 'intrinio', 'yfinance']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
