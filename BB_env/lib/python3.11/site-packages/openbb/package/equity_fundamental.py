...
class ROUTER_equity_fundamental(Container):
    ...
    def balance(
        ...
        period: Annotated[str, OpenBBCustomParameter(description='Time period of the data to return.')] = 'annual',
        limit: Annotated[Optional[Annotated[int, Ge(ge=0)]], OpenBBCustomParameter(description='The number of data entries to return.')] = 5,
        provider: Annotated[Optional[Literal['fmp', 'intrinio', 'polygon', 'yfinance']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def dividends(
        self,
        symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for. Multiple comma separated items allowed for provider(s): nasdaq.')],
        ...
        provider: Annotated[Optional[Literal['fmp', 'intrinio', 'nasdaq', 'tmx', 'yfinance']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def filings(
        ...
        form_type: Annotated[Optional[str], OpenBBCustomParameter(description='Filter by form type. Check the data provider for available types.')] = None,
        limit: Annotated[int, OpenBBCustomParameter(description='The number of data entries to return.')] = 100,
        provider: Annotated[Optional[Literal['fmp', 'intrinio', 'sec', 'tmx']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def historical_attributes(
        self,
        symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for. Multiple comma separated items allowed for provider(s): intrinio.')],
        tag: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Intrinio data tag ID or code. Multiple comma separated items allowed for provider(s): intrinio.')],
        start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None,
        end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None,
        ...
        tag_type: Annotated[Optional[str], OpenBBCustomParameter(description='Filter by type, when applicable.')] = None,
        sort: Annotated[Optional[Literal['asc', 'desc']], OpenBBCustomParameter(description='Sort order.')] = 'desc',
        provider: Annotated[Optional[Literal['intrinio']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'intrinio' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'multiple_items_allowed': ['intrinio']}, 'tag': {'multiple_items_allowed': ['intrinio']}},
            )
        )
    ...
    def historical_eps(
        self,
        symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for. Multiple comma separated items allowed for provider(s): alpha_vantage.')],
        provider: Annotated[Optional[Literal['alpha_vantage', 'fmp']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'alpha_vantage' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def income_growth(
        ...
        symbol: Annotated[str, OpenBBCustomParameter(description='Symbol to get data for.')],
        limit: Annotated[int, OpenBBCustomParameter(description='The number of data entries to return.')] = 10,
        period: Annotated[Literal['annual', 'quarter'], OpenBBCustomParameter(description='Time period of the data to return.')] = 'annual',
        provider: Annotated[Optional[Literal['fmp']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def management(
        self,
        symbol: Annotated[str, OpenBBCustomParameter(description='Symbol to get data for.')],
        provider: Annotated[Optional[Literal['fmp', 'yfinance']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def management_compensation(
        self,
        symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for. Multiple comma separated items allowed for provider(s): fmp.')],
        provider: Annotated[Optional[Literal['fmp']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def metrics(
        self,
        symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for. Multiple comma separated items allowed for provider(s): finviz, fmp, intrinio, yfinance.')],
        ...
        provider: Annotated[Optional[Literal['finviz', 'fmp', 'intrinio', 'yfinance']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'finviz' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'multiple_items_allowed': ['finviz', 'fmp', 'intrinio', 'yfinance']}},
            )
        )
    ...
    def overview(
        ...
        **kwargs
        ...
        warn("This endpoint is deprecated; use `/equity/profile` instead. Deprecated in OpenBB Platform V4.1 to be removed in V4.3.", category=DeprecationWarning, stacklevel=2)
    ...
    def ratios(
        ...
        provider: Annotated[Optional[Literal['fmp', 'intrinio']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def reported_financials(
        ...
        symbol: Annotated[str, OpenBBCustomParameter(description='Symbol to get data for.')],
        period: Annotated[str, OpenBBCustomParameter(description='Time period of the data to return.')] = 'annual',
        statement_type: Annotated[str, OpenBBCustomParameter(description='The type of financial statement - i.e, balance, income, cash.')] = 'balance',
        limit: Annotated[Optional[int], OpenBBCustomParameter(description='The number of data entries to return. Although the response object contains multiple results, because of the variance in the fields, year-to-year and quarter-to-quarter, it is recommended to view results in small chunks.')] = 100,
        provider: Annotated[Optional[Literal['intrinio']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'intrinio' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def trailing_dividend_yield(
        self,
        symbol: Annotated[str, OpenBBCustomParameter(description='Symbol to get data for.')],
        limit: Annotated[Optional[int], OpenBBCustomParameter(description='The number of data entries to return. Default is 252, the number of trading days in a year.')] = 252,
        provider: Annotated[Optional[Literal['tiingo']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'tiingo' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
