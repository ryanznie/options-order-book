...
class ROUTER_economy(Container):
    ...
    def calendar(
        ...
        provider: Annotated[Optional[Literal['fmp', 'nasdaq', 'tradingeconomics']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def composite_leading_indicator(
        ...
        start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None,
        end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None,
        provider: Annotated[Optional[Literal['oecd']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'oecd' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def fred_series(
        self,
        symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for. Multiple comma separated items allowed for provider(s): fred.')],
        start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None,
        end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None,
        limit: Annotated[Optional[int], OpenBBCustomParameter(description='The number of data entries to return.')] = 100000,
        chart: Annotated[bool, OpenBBCustomParameter(description='Whether to create a chart or not, by default False.')] = False,
        provider: Annotated[Optional[Literal['fred', 'intrinio']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fred' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def money_measures(
        ...
        provider: Annotated[Optional[Literal['federal_reserve']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'federal_reserve' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
