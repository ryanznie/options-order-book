...
class ROUTER_fixedincome_government(Container):
    ...
    def eu_yield_curve(
        ...
        provider: Annotated[Optional[Literal['ecb']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'ecb' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def treasury_auctions(
        self,
        security_type: Annotated[Literal['Bill', 'Note', 'Bond', 'CMB', 'TIPS', 'FRN', None], OpenBBCustomParameter(description='Used to only return securities of a particular type.')] = None,
        cusip: Annotated[Optional[str], OpenBBCustomParameter(description='Filter securities by CUSIP.')] = None,
        page_size: Annotated[Optional[int], OpenBBCustomParameter(description='Maximum number of results to return; you must also include pagenum when using pagesize.')] = None,
        page_num: Annotated[Optional[int], OpenBBCustomParameter(description='The first page number to display results for; used in combination with page size.')] = None,
        start_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format. The default is 90 days ago.')] = None,
        end_date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format. The default is today.')] = None,
        provider: Annotated[Optional[Literal['government_us']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'government_us' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def treasury_prices(
        self,
        date: Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='A specific date to get data for. No date will return the current posted data.')] = None,
        provider: Annotated[Optional[Literal['government_us', 'tmx']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'government_us' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def treasury_rates(
        ...
        provider: Annotated[Optional[Literal['federal_reserve', 'fmp']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'federal_reserve' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
