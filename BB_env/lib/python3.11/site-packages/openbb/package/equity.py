...
class ROUTER_equity(Container):
    ...
    def profile(
        self,
        symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for. Multiple comma separated items allowed for provider(s): finviz, fmp, intrinio, tmx, yfinance.')],
        provider: Annotated[Optional[Literal['finviz', 'fmp', 'intrinio', 'tmx', 'yfinance']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'finviz' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'multiple_items_allowed': ['finviz', 'fmp', 'intrinio', 'tmx', 'yfinance']}},
            )
        )
    ...
    def search(
        ...
        provider: Annotated[Optional[Literal['cboe', 'intrinio', 'nasdaq', 'sec', 'tmx', 'tradier']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'cboe' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
