...
class ROUTER_crypto_price(Container):
    ...
    def historical(
        self,
        symbol: Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for. Can use CURR1-CURR2 or CURR1CURR2 format. Multiple comma separated items allowed for provider(s): fmp, polygon, tiingo, yfinance.')],
        ...
        provider: Annotated[Optional[Literal['fmp', 'polygon', 'tiingo', 'yfinance']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'fmp' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
        ...
        return self._run(
            ...
            **filter_inputs(
                ...
                extra_params=kwargs,
                info={'symbol': {'multiple_items_allowed': ['fmp', 'polygon', 'tiingo', 'yfinance']}},
            )
        )
