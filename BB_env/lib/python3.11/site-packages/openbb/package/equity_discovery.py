...
class ROUTER_equity_discovery(Container):
    ...
    def gainers(
        self,
        sort: Annotated[Literal['asc', 'desc'], OpenBBCustomParameter(description="Sort order. Possible values: 'asc', 'desc'. Default: 'desc'.")] = 'desc',
        provider: Annotated[Optional[Literal['tmx', 'yfinance']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'tmx' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
    ...
    def top_retail(
        self,
        limit: Annotated[int, OpenBBCustomParameter(description='The number of data entries to return.')] = 5,
    ...
    def upcoming_release_days(
        self,
        provider: Annotated[Optional[Literal['seeking_alpha']], OpenBBCustomParameter(description="The provider to use for the query, by default None.\n    If None, the provider specified in defaults is selected or 'seeking_alpha' if there is\n    no default.")] = None,
        **kwargs
    ) -> OBBject:
